...
This will be an intrinsic feature for NuGet and hence the lock file should be generated by default for all NuGet restores. However, the feature would be behind a feature flag during it's preview. This will enable better dogfooding of the feature and help us make changes before we make this a public feature. To try this **preview** feature, user would need to set the following property in NuGet.config
```
