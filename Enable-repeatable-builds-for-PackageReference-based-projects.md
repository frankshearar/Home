...
* Simple format (similar to yarn.lock):
...
**Locking the dependency graph at a solution or repo level** Currently the lock file is proposed at per project level. In order to lock the dependencies at solution  or repo level, this would be solved as part of managing/controlling packages at a solution/repo level. This is called out in the requirement **R2** above. 
