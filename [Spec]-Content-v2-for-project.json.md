...
#### **Note:** if your project is using packages.config to define packages, this feature is explicitly turned off. See [here](https://github.com/NuGet/Home/wiki/Converting-a-csproj-from-package.config-to-project.json) on how to port over to project.json 
